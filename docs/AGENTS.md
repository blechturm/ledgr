...
- The active v0.1.9.6 packet is a validation-substrate and
  ...
  `inst/design/ledgr_v0_1_9_6_spec_packet/README.md`. It consumes the
  ...
  benchmark redo. Scope is canonical single-run returns, retained-return
