...
Current planning context (post-v0.1.9.4 release; v0.1.9.5 planned,
packet not yet cut):
...
| Area | Read |
|----|----|
| v0.1.9.5 planning context | `inst/design/ledgr_roadmap.md`, `inst/design/horizon.md`, `inst/design/contracts.md`, `inst/design/README.md` |
