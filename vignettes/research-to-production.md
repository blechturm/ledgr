...
- walk-forward evaluation runs over the existing sweep and run surfaces,
  ...
  risk-chain identity;
- v0.1.9.6 shipped DSR, PBO/CSCV, MinTRL, and deterministic
  effective-trial clustering over retained return panels; v0.1.9.7
  extends that evidence into business-objective eligibility and a public
  return-panel entry point;
