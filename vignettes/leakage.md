...
The current custom-indicator notes are in
[`custom-indicators.md`](custom-indicators.html). A forthcoming
documentation update promotes that material into the current
custom-indicator article and keeps the same warning: full-series custom
feature code must be written with causal discipline.
