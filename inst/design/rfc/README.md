...
| Ragged universe / asset lifetime | **gate without seed** | v0.2.x-v0.3.0; write a dedicated seed that first separates the offline research-validity substrate from the later live bad-data runtime, then decides whether one umbrella RFC or coordinated RFCs are warranted. Broad-equity universes with point-in-time membership and delistings remain blocked meanwhile. | `../research/Sharadar-Empirical-Evidence.md` (reviewed non-reconstructive empirical synthesis); `../research/ledgr_ragged_universe_prior_art_review.md`; `../research/rfc-evidence-handoff.md`; coordinate with `../research/Cross-Asset-Accounting-Critical-Events.md` | horizon 2026-05-28 `[data]` live bad-data / sim-to-real entry (direction B); horizon 2026-09-06 `[data]` evidence-routing entry; roadmap v0.2.x ragged-universe / asset-lifetime section |
