...
| B2 compiled hot frame | B2 is a production-parity measurement gate and scoped spot-FIFO accelerator path. Public opt-in is authorized only for memory-backed sweep spot-FIFO; durable compiled integration, non-spot accounting, and default compiled execution remain deferred. | `rfc_compiled_hot_frame_b2_v0_1_9_x_synthesis.md`, `rfc_compiled_hot_frame_b2_v0_1_9_x_maintainer_decisions.md` (Decision 2 narrowing) | `rfc_compiled_hot_frame_b2_v0_1_9_x_final_review.md`, `../adr/0005-b2-spot-fifo-scope-guard.md`, `../ledgr_v0_1_8_10_spec_packet/`, `../contracts.md` |
...
| --- | --- | --- | --- |
| B2 spot-FIFO scope guard | ADR-now. | `../adr/0005-b2-spot-fifo-scope-guard.md`, `rfc_compiled_hot_frame_b2_v0_1_9_x_synthesis.md`, `rfc_compiled_hot_frame_b2_v0_1_9_x_maintainer_decisions.md`, `rfc_compiled_hot_frame_b2_v0_1_9_x_final_review.md`, `../ledgr_v0_1_8_10_spec_packet/`, `../contracts.md` | ADR-0005 concentrates the durable "do not generalize this scoped accelerator" constraint. Reopen only through a future RFC that proposes durable compiled integration, non-spot compiled accounting, another compiled accounting model, or default compiled execution. |
