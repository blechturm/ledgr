...
| Asset availability / point-in-time universes / missing-data semantics | **in flight: Response reviewed** | v0.2.x-v0.3.0; the Stage 3 adversarial response was accepted at Stage 4 review on 2026-09-07. The bounded comparative architecture spike is next, followed by Seed v2. The non-binding seed separates the offline research-validity substrate from the later live bad-data runtime and requires comparative architecture evidence before synthesis selects storage, state-plane, or strategy-facing shapes. Broad-equity universes with point-in-time membership and delistings remain blocked meanwhile. | `../research/Sharadar-Empirical-Evidence.md` (reviewed non-reconstructive empirical synthesis); `../research/ledgr_ragged_universe_prior_art_review.md`; `../research/rfc-evidence-handoff.md`; coordinate with `../research/Cross-Asset-Accounting-Critical-Events.md` | `rfc_asset_availability_point_in_time_universes_v0_1_9_8_seed.md` (Seed v1, non-binding); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_response.md` (response stage, reviewed and non-binding); horizon 2026-05-28 and 2026-09-06 `[data]` entries; roadmap v0.2.x ragged-universe / asset-lifetime section |
