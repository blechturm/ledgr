...
| API and representation-boundary hardening | parked (seed staged, 2026-09-09) | Proposed v0.2.0 window. Run the small public-workflow probe required by `../spike_protocol.md`, then request a different-author response. Seed covers API tiers, the existing export manifest, accounting/provenance ownership, audit-led hardening, cohesive file moves, `ledgr_run_fold()` phase extraction, and teaching/accessor gaps. No runtime probe or implementation is claimed complete. | [Seed v1](rfc_api_representation_hardening_v0_2_0_seed.md); [initial test audit](../audits/v0_2_0_test_suite_audit.md) | horizon 2026-09-04 `[infrastructure]` and `[docs]` review entries; v0.1.9.x planned roadmap row; accepted naming and asset-availability syntheses linked in the seed |
