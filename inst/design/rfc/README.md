...
| Asset availability / point-in-time universes / missing-data semantics | **in flight: Spike chartered** | v0.2.x-v0.3.0; the Stage 3 response and Stage 4 follow-up review are complete. Execute the bounded comparative architecture spike against the reviewed semantic charter, then write Seed v2. The non-binding RFC separates the offline research-validity substrate from the later live bad-data runtime and requires semantic conformance before representation measurements can inform storage, state-plane, or strategy-facing choices. Broad-equity universes with point-in-time membership and delistings remain blocked meanwhile. | `../research/Sharadar-Empirical-Evidence.md` (reviewed non-reconstructive empirical synthesis); `../research/ledgr_ragged_universe_prior_art_review.md`; `../research/rfc-evidence-handoff.md`; coordinate with `../research/Cross-Asset-Accounting-Critical-Events.md` | `rfc_asset_availability_point_in_time_universes_v0_1_9_8_seed.md` (Seed v1, non-binding); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_response.md` (response stage, reviewed and non-binding); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_response_review_addendum.md` (Stage 4 follow-up); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_spike_charter.md` (chartered, not started); horizon 2026-05-28 and 2026-09-06 `[data]` entries; roadmap v0.2.x ragged-universe / asset-lifetime section |
