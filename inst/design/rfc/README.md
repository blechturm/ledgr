...
| Asset availability / point-in-time universes / missing-data semantics | **accepted spec; tickets cut** | The reviewed comparative spike closed inconclusive on 2026-09-08 and selected no representation or performance winner. Seed v2 and three final-review patch sets produced the accepted synthesis. The maintainer accepted the [combined v0.2.0.0 spec](../ledgr_v0_2_0_0_spec_packet/v0_2_0_0_spec.md) on 2026-09-09, including explicit quarantine and active short-exposure amendments. LDG-2687 through LDG-2702 implement and teach the first bounded availability path after hardening; Batch 0 awaits review and no implementation gate is yet passed. | `../research/Sharadar-Empirical-Evidence.md` (reviewed non-reconstructive empirical synthesis); `../research/ledgr_ragged_universe_prior_art_review.md`; `../research/rfc-evidence-handoff.md`; coordinate with `../research/Cross-Asset-Accounting-Critical-Events.md` | `rfc_asset_availability_point_in_time_universes_v0_1_9_8_seed.md` (Seed v1, historical); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_response.md` (reviewed response); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_response_review_addendum.md`; `rfc_asset_availability_point_in_time_universes_v0_1_9_8_spike_charter.md`; `rfc_asset_availability_point_in_time_universes_v0_1_9_8_seed_v2.md` (maintainer accepted; synthesis input); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_synthesis.md` (accepted 2026-09-08); `../ledgr_v0_2_0_0_spec_packet/` (active implementation packet); terminal spike report on `spike/asset-availability-pit-universes` at `d59259f` |
...
| API and representation-boundary hardening | **accepted spec; tickets cut** | The maintainer accepted the [combined v0.2.0.0 spec](../ledgr_v0_2_0_0_spec_packet/v0_2_0_0_spec.md) on 2026-09-09. LDG-2673 through LDG-2686 own the five ordered hardening slices and H1-H12: pro rata reversal fees, eager fills with cursor removal, repaired sweep/risk lineage, recorded run risk identity, durable locator teaching, bounded ownership/coordinator extraction, finalization recovery, and scoped causal/RNG/cleanup/wide-name corrections. Batch 0 awaits review; no hardening implementation gate is yet passed. | `rfc_api_representation_hardening_v0_2_0_seed.md`; `rfc_api_representation_hardening_v0_2_0_response.md`; `rfc_api_representation_hardening_v0_2_0_response_review.md`; `rfc_api_representation_hardening_v0_2_0_synthesis.md` (accepted); `rfc_api_representation_hardening_v0_2_0_synthesis_review.md`; `dev/spikes/api-representation-hardening/probe.R`, `review_gut_fold_rollback.R` and `probe_findings.md`; `../audits/v0_2_0_test_suite_audit.md` Section 7 measured evidence | `rfc_api_representation_hardening_v0_2_0_synthesis.md`; `../ledgr_v0_2_0_0_spec_packet/` (active implementation packet); horizon 2026-09-09 `[infrastructure]`; `../spike_protocol.md` |
