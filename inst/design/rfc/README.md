...
| Asset availability / point-in-time universes / missing-data semantics | **in flight: synthesis** | v0.2.x-v0.3.0; the reviewed comparative spike closed inconclusive on 2026-09-08: its shared semantic boundary passed the implemented subset, but it produced no representation or performance winner. Seed v2 binds the proposed logical semantics and ingestion-usability bar while leaving physical encoding unselected; independent review closed and the maintainer accepted it on 2026-09-08. Claude synthesis is next. Broad-equity universes with point-in-time membership and delistings remain blocked meanwhile. | `../research/Sharadar-Empirical-Evidence.md` (reviewed non-reconstructive empirical synthesis); `../research/ledgr_ragged_universe_prior_art_review.md`; `../research/rfc-evidence-handoff.md`; coordinate with `../research/Cross-Asset-Accounting-Critical-Events.md` | `rfc_asset_availability_point_in_time_universes_v0_1_9_8_seed.md` (Seed v1, historical); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_response.md` (reviewed response); `rfc_asset_availability_point_in_time_universes_v0_1_9_8_response_review_addendum.md`; `rfc_asset_availability_point_in_time_universes_v0_1_9_8_spike_charter.md`; `rfc_asset_availability_point_in_time_universes_v0_1_9_8_seed_v2.md` (maintainer accepted; synthesis input); terminal spike report on `spike/asset-availability-pit-universes` at `d59259f`; horizon 2026-05-28 and 2026-09-06 `[data]` entries; roadmap v0.2.x ragged-universe / asset-lifetime section |
