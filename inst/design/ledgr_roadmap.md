...
**Active packet:** v0.1.9.2 sweep artifact persistence.
**Active packet path:** `inst/design/ledgr_v0_1_9_2_spec_packet/`.
...
| v0.1.9.2 | Active | Sweep artifact persistence: durable saved-sweep artifacts, optional retained net equity/return series for completed candidates, reopened-sweep candidate compatibility, and compact retention infrastructure for later walk-forward. | `inst/design/ledgr_v0_1_9_2_spec_packet/` |
