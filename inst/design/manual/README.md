...
|----|----|----|----|
| [`execution_fold_core.md`](execution_fold_core.md) | `execution_fold_core.qmd` | Updated through v0.2.0.0 | Shared fold core, pulse lifecycle, availability economics, output handlers, trust boundary, and B2 guard. |
...
| [`snapshots_data.md`](snapshots_data.md) | `snapshots_data.qmd` | Updated through v0.2.0.0 | Snapshot sealing, availability facts and quarantine, split stores, fold-entry guards, and data provenance. |
...
| [`features.md`](features.md) | `features.qmd` | Updated through v0.2.0.0 | Feature maps, aliases, strict availability gaps, cache/projection path, adapters, and runtime lookup. |
...
| [`benchmark_methodology.md`](benchmark_methodology.md) | `benchmark_methodology.qmd` | Maintained; four-phase peer clock updated in LDG-2732 | Local benchmark record generation, cold/warm phase separation, repeatability expectations, release-gate checks, and public-claim boundaries. |
| [`identity_contract.md`](identity_contract.md) | `identity_contract.qmd` | Updated through v0.2.0.0 | Config, snapshot, availability, feature, alias, cost, risk, and walk-forward identity fields. |
...
| [`optimization_coding_style.md`](optimization_coding_style.md) | `optimization_coding_style.qmd` | Maintained; production anchors updated in LDG-2732 | Coding style distilled from the optimization arc: the recurring per-element shapes, their replacements, prepare-before-the-loop, boundary-only frames, typed buffer writes, cursors, identity and measurement discipline. |
