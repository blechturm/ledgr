...
states that `LTB-0019` "covers independent opening, reversal, short, dust and
512-lot arithmetic". `LTB-0019` contains no fractional quantity anywhere; every
...
same is true of `LCL-0016`, registered for exactly this arithmetic.
