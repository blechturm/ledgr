...
A backtest handle points to stored run artifacts and may own DuckDB resources
while it is live. The artifacts are already durable; `close(bt)` is
deterministic cleanup for scripts, tests, and long sessions.
