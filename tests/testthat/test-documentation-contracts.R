...
testthat::test_that("v0.2.0.1 packet implementation status is aligned", {
  ...
  names(docs) <- c(
    ...
    "batch2_evidence", "batch3_evidence"
  )
  ...
  testthat::expect_identical(
    batch_statuses,
    c(rep("Complete After Review.", 4L), rep("Pending.", 5L))
  )
