...
testthat::test_that("ledgr_compare_runs prints curated view while preserving numeric metrics", {
  ...
  testthat::expect_type(cmp$annualized_return, "double")
  testthat::expect_type(cmp$volatility, "double")
  testthat::expect_type(cmp$sharpe_ratio, "double")
  testthat::expect_type(cmp$avg_trade, "double")
  testthat::expect_type(cmp$time_in_market, "double")
  ...
  testthat::expect_true(any(grepl("%", printed, fixed = TRUE)))
  testthat::expect_true(any(grepl("sharpe_ratio", printed, fixed = TRUE)))
  testthat::expect_true(any(grepl("Full identity and telemetry columns", printed, fixed = TRUE)))
