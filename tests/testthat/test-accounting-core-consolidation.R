...
testthat::test_that("[LTB-0018] flat lot carrier preserves independent FIFO arithmetic", {
...
# ledgr-test-profile: review
testthat::test_that("[LTB-0019] one preparer gives memory and table sources one block", {
...
testthat::test_that("[LTB-0020] chunked reader is identical across its fetch boundary", {
...
# ledgr-test-profile: review
testthat::test_that("[LTB-0021] depth scaling detector rejects a write-path rescan", {
