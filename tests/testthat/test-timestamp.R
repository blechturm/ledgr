...
test_that("iso_utc rejects unsupported formats", {
  expect_error(iso_utc("01/02/2020"), "trailing `Z`")
  expect_error(iso_utc("2020-01-01T12:34"), "2020-01-01T00:00:00Z", fixed = TRUE)
  expect_error(iso_utc("2016-12-31T23:59:60Z"), "UTC timestamp")
