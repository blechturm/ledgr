...
`ledgr_run()` returns a live handle. The run artifacts are already durable, but
closing the handle is the deterministic way to checkpoint and release DuckDB
resources in scripts and long sessions.
