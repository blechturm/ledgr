...
Current planning context (v0.1.9.2 sweep artifact persistence active packet):
...
- The active v0.1.9.2 packet is sweep artifact persistence:
  ...
  and compact retention infrastructure for later walk-forward. Ranking helpers,
  named selection views, benchmark diagnostics, signal decay, implementation/
  cost decay, gross-vs-net attribution, and walk-forward integration are
  explicit non-scope.
